<template>
  <div class="job-info">
    <i style="width:100%;text-align:right" class="el-icon-printer" @click="$router.push('/employees/print/'+ userId)" />
    <!-- 基础信息 -->
    <el-form label-width="220px">
      ...
      <!-- 从业信息 -->
      <el-form-item>
        <el-button type="primary" @click="saveEmployessJobInfo">保存更新</el-button>
...
import { getEmployeesJobInfo, saveEmployessJobInfo } from '@/api/employee'
export default {
  data() {
    return {
